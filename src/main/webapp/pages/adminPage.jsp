        ...
        <table id="table" class="table table-condensed table-bordered table-hover">
            ...
            <c:forEach var="house" items="${houses}">
                <tr>
                    ...
                    <td>
                        <button id="btn-detail" class="btn btn-primary" onclick="detail('${house.houseId}')">详情
                        </button>
                    </td>
                    <td>
                    ...
                    <c:if test="${house.houseToken eq '1'}">
                        <td>
                            <button id="btn-eav" class="btn btn-warning"  onclick="examine('<%=contextPath%>','${house.houseId}')">审核</button>
                        </td>
                    </c:if>
                    <c:if test="${house.houseToken eq '2'}">
                        <td></td>
                    </c:if>
                    <td>
...
<div>
    <button id="btn-add" class="btn btn-success" onclick="addHouse()">添加</button>
</div>
