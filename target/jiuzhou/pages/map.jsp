...
<head>
    ...
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=mkKoxpK14h2zsHssGZRDUyZemd062g8W"></script>
</head>
<body>
<div style="width:300px;height:250px;border:#ccc solid 1px;" id="dituContent"></div>
</body>
